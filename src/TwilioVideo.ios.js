...
export default class TwilioVideo extends Component {
   ...
   */
  connect ({ roomName, accessToken, enableAudio = true, enableVideo = true, encodingParameters = null, enableNetworkQualityReporting = false, dominantSpeakerEnabled = false, bandwidthProfileOptions = null, simulcast = false }) {
    TWVideoModule.connect(accessToken, roomName, enableAudio, enableVideo, encodingParameters, enableNetworkQualityReporting, dominantSpeakerEnabled, bandwidthProfileOptions, simulcast);
  }
